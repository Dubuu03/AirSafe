...
export const mockTrendData: Record<'day' | 'week' | 'month', TrendData> = {
  day: {
    ...
    summary: { co2: { avg: 420, min: 380, max: 480 }, pm25: { avg: 25, min: 15, max: 40 }, voc: { avg: 60, min: 35, max: 90 } },
  },
  week: {
    period: 'week',
    ...
    summary: { co2: { avg: 450, min: 380, max: 550 }, pm25: { avg: 30, min: 18, max: 55 }, voc: { avg: 70, min: 40, max: 110 } },
  },
  month: {
    period: 'month',
    ...
    summary: { co2: { avg: 440, min: 350, max: 580 }, pm25: { avg: 35, min: 15, max: 65 }, voc: { avg: 75, min: 35, max: 120 } },
  },
};
